    ...
    <div class="grid md:grid-cols-2 gap-10 max-w-5xl w-full mx-auto items-center">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!-- Register Button as link -->
                <a href="{{ route('register') }}" class="inline-flex justify-center px-8 py-2 w-48 text-sm rounded-[50px] border border-[#89FFE7] text-[#2E7099] hover:bg-[#89FFE7] hover:text-white font-semibold uppercase tracking-widest shadow-sm transition ease-in-out duration-150">
                    {{ __('Register') }}
                </a>
            </div>
        </form>
