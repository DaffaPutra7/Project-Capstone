        ...
        <section class="rounded-3xl shadow-xl border-2 border-[#89FFE7] bg-white overflow-hidden">
            ...
            <div class="p-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <figure class="overflow-hidden rounded-2xl shadow-md bg-white border flex flex-col h-full hover:shadow-lg transition-shadow duration-300">
                        {{-- Gambar --}}
                        <div class="h-48 overflow-hidden">
                            <img src="{{ asset('storage/' . $foto->path_foto) }}"
                                class="w-full h-full object-cover hover:scale-105 transition-transform duration-500"
                                alt="{{ $foto->deskripsi ?? 'Kegiatan TK' }}">
                        </div>
                        
                        {{-- Deskripsi (Ditambahkan) --}}
                        <div class="p-4 flex-grow flex items-center justify-center bg-sky-50">
                            <p class="text-sm text-center text-gray-700 font-semibold">
                                {{ $foto->deskripsi ?? 'Tanpa Keterangan' }}
                            </p>
                        </div>
                    </figure>
                    @endforeach
