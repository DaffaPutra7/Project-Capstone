<x-app-layout>
    ...
    <main class="space-y-12">
        ...
        {{-- INFO CARD STATUS & TOMBOL DAFTAR ULANG --}}
        <div class="mt-8 bg-white rounded-2xl p-5 shadow-md border border-[#89FFE7]">
            ...
            {{-- TOMBOL DAFTAR ULANG (HANYA MUNCUL JIKA DITERIMA) --}}
            @if ($currentStatus == 'Diterima')
                <div class="mt-4 pt-4 border-t border-gray-100 flex justify-center sm:justify-start">
                    <a href="https://wa.me/6282294226428?text=Assalamu%27alaikum%20Admin%2C%20saya%20{{ urlencode(Auth::user()->nama_lengkap) }}%20(Status%3A%20Diterima)%20ingin%20melakukan%20konfirmasi%20daftar%20ulang."
                       target="_blank"
                       class="flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg hover:shadow-emerald-200 hover:scale-105 transition-all duration-300">
