<x-app-layout>
    <main class="max-w-6xl mx-auto py-10 px-6">
        ...
        <section class="bg-white border border-[#89FFE7] shadow-sm rounded-[50px] p-8">
            <h3 class="text-sky-700 font-semibold mb-4">Formulir Pendaftaran Reguler</h3>
            ...
            <form action="#" method="POST" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <textarea class="w-full rounded-[50px] border-gray-300 shadow-sm focus:border-[#89FFE7] focus:ring-[#89FFE7]"></textarea>
                            </div>
                        </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <label class="flex items-center space-x-2">
                                        <input type="radio" name="gender" value="Laki-laki"
                                            class="text-[#89FFE7] focus:ring-[#89FFE7]" />
                                        <span>Laki-laki</span>
                                    </label>
                                    <label class="flex items-center space-x-2">
                ...
                <div class="pt-6 text-center">
                    <button type="submit"
                        class="bg-sky-600 hover:bg-sky-700 text-white font-semibold py-2 px-10 rounded-[50px] shadow-md">
                        Reguler
                    </button>
                </div>
            </form>
